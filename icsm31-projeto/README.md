...
| Gerar **relatório com todas as imagens** (imagem + iterações + tempo) | [client/report_generator.py](client/report_generator.py) — imagem em [`report_generator.py:117-120`](client/report_generator.py#L117-L120), iterações em [`report_generator.py:59`](client/report_generator.py#L59), tempo em [`report_generator.py:60`](client/report_generator.py#L60). Chamado em [`client.py:462-465`](client/client.py#L462-L465) |
